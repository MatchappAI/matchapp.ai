      ...
      <main className="mx-auto max-w-2xl px-6 py-12">
        <div className="rounded-3xl border border-foreground/[0.08] bg-foreground/[0.02] p-8 sm:p-10">
          ...
          <p className="mt-3 text-sm leading-6 text-muted-foreground">
            ...
            not provide escrow, hold funds, release payments, or process creator-brand payments. Any
            payment status shown in MatchAI is creator-reported and handled externally.
          </p>
