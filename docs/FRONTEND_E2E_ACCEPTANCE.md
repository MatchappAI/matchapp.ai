...
| `/dashboard/inbox`, compose                         | Enter To/CC/BCC/Reply-To/body, attach, save draft                         | Draft remains editable and appears in Drafts                            | Insert/update `email_drafts`, `email_threads`, and attachment records                                            | No send                                                       | Draft survives reload and folder refresh                      | Validation and attachment limits visible                     | All fields labeled; keyboard operable                             |
| `/dashboard/inbox`, compose/reply/reply-all/forward | Review exact message                                                      | Confirmation shows exact action and all final fields                     | Insert idempotent pending `email_action_requests`                                                               | Required                                                      | Pending request recorded                                     | Preparation failure leaves draft editable                    | Alert dialog labeled; Escape closes; initial focus lands in dialog |
| `/dashboard/inbox`, confirmation                    | Cancel                                                                    | Dialog closes; nothing sends                                             | No provider mutation                                                                                            | Cancel is final                                               | Draft remains                                                | N/A                                                          | Escape closes; focus returns to creator surface                   |
...
- compose with CC/BCC, attachment, save draft, cancel confirmation, edit draft threads;
